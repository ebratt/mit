...
public class Card implements Comparable<Object> {
	...
	public Card(CardValue aValue, CardSuit aSuit) {
		if (aValue == null) throw new IllegalArgumentException("CardValue may not be null");
		if (aSuit == null) throw new IllegalArgumentException("CardSuit may not be null");
		this.value = aValue;
		this.suit = aSuit;
	}
	 ...
	 *          <code>ClassCastException</code></li> <li>If <code>o</code> is
	 *          null, throws a <code>NullPointerException</code></li> <li>
	 *          Returns a negative integer, zero, or a positive integer if this
	 *          <code>Card</code> is less than, equal to, or greater than the
